...
Version `0.9.8-preview` (version code 21) provides the native mobile feature set
for infrastructure, instances, voice servers, MSG servers, websites, backups,
users, roles, system administration, and settings. It also introduces the new
blnk - Base tower/orbit app icon.

The APK is published in the
[`v0.9.8-preview` release](https://github.com/blnk-projects/BlenkBase-Mobile/releases/tag/v0.9.8-preview).
